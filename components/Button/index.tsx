...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-[#22c55e] text-white hover:bg-[#16a34a] active:bg-[#15803d] focus:ring-green-500',
    ...
    gradient: 'bg-[linear-gradient(90deg,#3b82f6_0%,#8b5cf6_100%)] text-white hover:opacity-90 active:opacity-80 focus:ring-blue-500'
  };
  ...
  const responsiveRadius = 'rounded-sm sm:rounded-xl md:rounded-md';
