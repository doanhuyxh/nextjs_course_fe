...
export default function GuestActions() {
    ...
    return (
        <div className="flex gap-2">
            <div onClick={()=>navigation("/login")} className="btn_login cursor-pointer">
                <span className="text-nowrap cursor-pointer">Đăng nhập</span>
            </div>
            <div onClick={()=>navigation("/login")} className="btn_register cursor-pointer">
                <span className="text-nowrap cursor-pointer">Đăng ký và học thử ngay</span>
            </div>
